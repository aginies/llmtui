    ...
    pub fn new(config: Config) -> Self {
        ...
        Self {
            ...
            picker: PickerState {
                ...
                prompt_picker_scroll_offset: 0,
                profile_picker_entries: Vec::new(),
                profile_picker_selected: 0,
                profile_picker_scroll_offset: 0,
                ...
                editing_rpc_worker_tensor_split: None,
                rpc_worker_tensor_split_buffer: String::new(),
                rpc_worker_tensor_split_cursor_pos: 0,
            ...
            server: ServerState {
                ...
                web_search_config: std::sync::Arc::new(std::sync::RwLock::new(
                    crate::serve_api::WebSearchConfig {
                        engine: String::new(),
