...
pub struct ServerState {
    ...
    pub running_ws_tls: Option<bool>,
    pub running_api_port: Option<u16>,
    pub running_api_server_port: Option<u16>,
    pub running_api_model: Option<String>,
    pub running_ws_tls_cfg: Option<axum_server::tls_rustls::RustlsConfig>,
    pub running_ws_tls_cert_path: Option<String>,
    pub running_ws_tls_key_path: Option<String>,
