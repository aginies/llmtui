...
const METRIC_GROUPS = [
    { name: 'Model', metrics: ['model_name'] },
    { name: 'Performance', metrics: ['tps', 'prompt_tps', 'gen_tps', 'decoded_tokens', 'prompt_tokens', 'prompt_progress'] },
    { name: 'Resources', metrics: ['ctx', 'vram', 'ram', 'cpu'] },
];
